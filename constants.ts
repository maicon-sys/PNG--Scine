...
export const INITIAL_SECTIONS: PlanSection[] = [
  ...
  // --- CAPÍTULO 11: ANEXOS ---
  { id: '11.0', chapter: '11. ANEXOS', title: '11.0 Introdução Anexos', description: 'Este capítulo serve para apresentar as evidências documentais que suportam as afirmações feitas ao longo do plano. Cada subseção deve extrair e apresentar os dados mais relevantes do documento correspondente, tornando o texto autossuficiente.', content: '', status: SectionStatus.PENDING, type: SectionType.TEXT, isLocked: true },
